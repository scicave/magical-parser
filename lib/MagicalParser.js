/*!
 * 
 * magical-parser v1.0.0       Thu Feb 13 2020 23:04:41 GMT+0200 (Eastern European Standard Time)
  ...
  _createClass(Parser, [{
    ...
    value: function parse(str) {
      ...
      if (this.regex && str) {
        ...
        groups = _toConsumableArray(groups);
        groups.pop();
  ...
  _createClass(CustomMathParser, [{
    ...
    value: function __parseBlocks(str, options, operations) {
      ...
      var repBlock = function repBlock(match, content) {
        ...
        if (b.parser) {
          if (b.parser === 'inherit') {
            args = [_this.__parser(content, options, operations)];
          } else {
    ...
    value: function __parseOperators(str, options, operations) {
      ...
      str = str.replace(options.opIntialTestReg, function (match, prefix, arg) {
        if (prefix) {
          var name = Object(_global_js__WEBPACK_IMPORTED_MODULE_3__["getRandomName"])();
          var sn = new _Node_js__WEBPACK_IMPORTED_MODULE_2__["default"]("prefixOperator", _this2.__parseArg(arg), {
            id: prefix,
            match: match
          });
          operations.set(name, sn);
      ...
      while (!end) {
        ...
        str = str.replace(options.opTestReg, function (match, suffix, op, prefix, arg) {
          ...
          if (suffix) {
            ...
            var name = Object(_global_js__WEBPACK_IMPORTED_MODULE_3__["getRandomName"])();
            var sn = new _Node_js__WEBPACK_IMPORTED_MODULE_2__["default"]("suffixOperator", _this2.__parseArg(prevArg), {
              id: suffix
            });
            operations.set(name, sn);
            prevArg = name;
          ...
          if (prefix) {
            ...
            var _sn = new _Node_js__WEBPACK_IMPORTED_MODULE_2__["default"]("prefixOperator", _this2.__parseArg(arg), {
              id: prefix
            });
        ...
        while (!end) {
          ...
          if (Object(_global_js__WEBPACK_IMPORTED_MODULE_3__["contains"])(_str, options.operators[i].id)) {
            _str = _str.replace(new RegExp("(".concat(options.argTest, ")\\s*(").concat(options.operators[i].regexStr, ")\\s*(").concat(options.argTest, ")")), function (match, g1, op, g2) {
              var arg1 = _this2.__parseArg(g1),
                  arg2 = _this2.__parseArg(g2);
    ...
    key: "__parseArg",
    value: function __parseArg(str, operations) {
      ...
      str = str.replace(options.operationTestReg, function (match, funcName, opName) {
        var snode = operations.get(opName);

        if (funcName && snode.type === 'block' && snode.id === '()') {
...
function sendError(type, msg) {
  ...
  switch (type) {
    case "forbiddenChars":
      throw new _errors_js__WEBPACK_IMPORTED_MODULE_0__["forbiddenCharsError"](msg);
...
function prepareOptions(options) {
  ...
  options.argTest = "".concat(options.nameTest, "|").concat(options.numTest, "|").concat(options.operationTest);
